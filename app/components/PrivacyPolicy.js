...
class PrivacyPolicy extends Component {
    ...
    render() {
        return (
            <div>
                <div id="ppHeader">https://toilettracker.halversondm.com/ Privacy Policy</div>
                <div id="ppBody">
                        ...
                        <div className="col-2">
                            <div className="col-12 quick-links2 gen-text-center">
                                ...
                                <div className="col-8 gen-text-left gen-xs-text-center"
                                     style={{fontSize: "12px", position: "relative", left: "20px"}}>
                    ...
                    <div className="grayText"><strong>What personal information do we collect from the people that visit
                        ...
                        or app?</strong></div>
                    <br/>
                    <div className="innerText">When ordering or registering on our site, as appropriate, you may be
                        asked to enter your
                    ...
                    <br/>
                    <div className="innerText">We collect information from you when you register on our site or enter
                        information on our
                        site.
                    </div>
                    ...
                    <br/>
                    <div className="innerText"> We may use the information we collect from you when you register, make a
                        purchase, sign
                        up
                        for our newsletter, respond to a survey or marketing communication, surf the website, or use
                        certain other
                        site
                        features in the following ways: <br/>We may contact you about the application.<br/></div>
                    <span id="infoPro"/><br/>
                    <div className="grayText"><strong>How do we protect your information?</strong></div>
                    <br/>
                    <div className="innerText">We do not use vulnerability scanning and/or scanning to PCI standards.
                    </div>
                    <div className="innerText">We only provide articles and information. We never ask for credit card
                        numbers.
                    </div>
                    <div className="innerText">We do not use Malware Scanning.<br/><br/></div>
                    <div className="innerText">Your personal information is contained behind secured networks and is
                        only accessible by
                        a
                    ...
                    <br/>
                    <div className="innerText">We implement a variety of security measures when a user enters, submits,
                        or accesses
                        their
                        information to maintain the safety of your personal information.
                    </div>
                    <br/>
                    <div className="innerText">All transactions are processed through a gateway provider and are not
                        stored or processed
                        on
                        our servers.
                    </div>
                    ...
                    <div className="innerText"><br/>You can choose to have your computer warn you each time a cookie is
                        being sent, or
                        you
                        can choose to turn off all cookies. You do this through your browser settings. Since each
                        browser is
                        a little
                        different, look at your browser's Help Menu to learn the correct way to modify your
                        cookies.<br/></div>
                    <br/>
                    <div className="innerText">If you turn cookies off, some features will be disabled. that make your
                        site experience
                        more
                    ...
                    <br/>
                    <div className="innerText">We do not sell, trade, or otherwise transfer to outside parties your
                        Personally
                        Identifiable
                        Information.
                    </div>
                    ...
                    <br/>
                    <div className="innerText">We do not include or offer third-party products or services on our
                        website.
                    </div>
                    <span id="gooAd"/><br/>
                    ...
                    <div className="innerText">Google's advertising requirements can be summed up by Google's
                        ...
                        <br/><br/></div>
                    <div className="innerText">We have not enabled Google AdSense on our site but we may do so in the
                        future.
                    </div>
                    <span id="calOppa"/><br/>
                    <div className="blueText"><strong>California Online Privacy Protection Act</strong></div>
                    <br/>
                    <div className="innerText">CalOPPA is the first state law in the nation to require commercial
                        websites and online
                        ...
                        See
                        more at:&nbsp;
                        <a href="http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf">http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf</a><br/>
                    </div>
                    ...
                    <div className="innerText">Once this privacy policy is created, we will add a link to it on our home
                        page or as a
                        minimum, on the first significant page after entering our website.<br/></div>
                    <div className="innerText">Our Privacy Policy link includes the word 'Privacy' and can easily be
                        found on the page
                        specified above.
                    </div>
                    <div className="innerText"><br/>You will be notified of any Privacy Policy changes:</div>
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> On our Privacy
                        Policy Page<br/>
                    </div>
                    <div className="innerText">Can change your personal information:</div>
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By emailing us
                    </div>
                    <div className="innerText"><br/><strong>How does our site handle Do Not Track signals?</strong><br/>
                    </div>
                    <div className="innerText">We honor Do Not Track signals and Do Not Track, plant cookies, or use
                        advertising when a
                        Do
                    ...
                    <div className="innerText">It's also important to note that we do not allow third-party behavioral
                        tracking
                    </div>
                    <span id="coppAct"/><br/>
                    <div className="blueText"><strong>COPPA (Children Online Privacy Protection Act)</strong></div>
                    <br/>
                    <div className="innerText">When it comes to the collection of personal information from children
                        under the age of 13
                        ...
                        online.<br/><br/></div>
                    <div className="innerText">We do not specifically market to children under the age of 13 years
                        old.
                    </div>
                    <span id="ftcFip"/><br/>
                    <div className="blueText"><strong>Fair Information Practices</strong></div>
                    <br/>
                    <div className="innerText">The Fair Information Practices Principles form the backbone of privacy
                        law in the United
                    ...
                    <div className="innerText"><strong>In order to be in line with Fair Information Practices we will
                        take the following
                        responsive action, should a data breach occur:</strong></div>
                    <div className="innerText">We will notify you via email</div>
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Within 1 business
                        day
                    </div>
                    <div className="innerText"><br/>We also agree to the Individual Redress Principle which requires
                        that individuals
                        have
                    ...
                    <br/>
                    <div className="innerText">The CAN-SPAM Act is a law that sets the rules for commercial email,
                        establishes
                        requirements
                    ...
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Send information,
                        respond to
                    ...
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Not use false or
                        misleading
                        subjects
                        or email addresses.
                    </div>
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Identify the
                        message as an
                        advertisement in some reasonable way.
                    </div>
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Include the
                        physical address of
                        our
                    ...
                    <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Allow users to
                        unsubscribe by
                        using
                        the link at the bottom of each email.
                    </div>
                    <div className="innerText"><strong><br/>If at any time you would like to unsubscribe from receiving
                        future emails,
                        you
                        can email us at <a href="mailto:toilet.training.tracker@gmail.com">Toilet Training
                            Tracker</a></strong></div>
                    and we will promptly remove you from <strong>ALL</strong> correspondence.
                </div>
                <br/><span id="ourCon"/><br/>
                <div className="blueText"><strong>Contacting Us</strong></div>
                <br/>
                <div className="innerText">If there are any questions regarding this privacy policy, you may contact us
                    using the
                    information below.<br/><br/></div>
                <div className="innerText">https://toilettracker.halversondm.com/</div>
                <div className="innerText">2314 Shiloh Dr</div>
                Aurora, IL 60503
                <div className="innerText">United States</div>
                <div className="innerText">toilet.training.tracker@gmail.com</div>
                <div className="innerText"><br/>Last Edited on 2017-02-21</div>
            </div>
        );
    }
}
