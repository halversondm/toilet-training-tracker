...
export class PrivacyPolicy extends React.Component<any, any> {
    ...
    private url: string = "http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf";
        ...
        return (
            <div>
                ...
                <div id="ppBody">
                    ...
                    <div className="innerText"><br /><strong>How does our site handle Do Not Track signals?</strong>
                    <br />
                    </div>
